...
<head>
            ...
            <meta charset="utf-8">
        <title>MY Outsourcing Limited</title>
            ...
            <div class="carousel-inner" role="listbox">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="slide-text slide_style_left">
                                <h1 data-animation="animated zoomInRight"><i>Discover the Reliable Outsourced</i></h1>
                                <p style="font-size: 30px;" data-animation="animated fadeInLeft"><i>MY Outsourcing Limited</i></p>
                                
                                    <a href="solution.php" class="btn btn-default" data-animation="animated fadeInLeft">Trusted Solutions</a>
                                    <a href="service.php" class="btn btn-primary" data-animation="animated fadeInRight">Reliable Services</a>    
               ...
               <!--  <div class="item">
                    ...
                    <div class="slide-text slide_style_center">
                        <h1 data-animation="animated flipInX">MY Outsourcing Limited</h1>
                        <p data-animation="animated lightSpeedIn">MY Outsourcing Limited</p>
                        
                        <a href="#" class="btn btn-default" data-animation="animated fadeInUp">MY Outsourcing Limited</a>
                        <a href="#" class="btn btn-primary" data-animation="animated fadeInDown">MY Outsourcing Limited</a>  
                ...
                <div class="item">
                    ...
                    <div class="slide-text slide_style_right">
                        <h1 data-animation="animated zoomInLeft"><i>Innovative in Highest Level of</i></h1>
                        <!-- <h1 data-animation="animated fadeInRight">Customer Support</h1> -->
                        <p style="font-size: 30px;" data-animation="animated fadeInRight"><i>Customer Support</i></p>
                        
                        <a href="training.php" class="btn btn-default" data-animation="animated fadeInLeft">Expert Trainers</a>
                        <a href="overview.php" class="btn btn-primary" data-animation="animated fadeInRight">Overview</a>    
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aama" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable">
        <p class="moto-text_system_5">Reliable Outsourced&nbsp;&nbsp;<span class="moto-color1_3">—</span></p>
        <h1 class="moto-text_system_4">CUSTOMER SUPPORT</h1></div>
</div><div class="moto-widget moto-widget-row moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-grid-type="sm" data-widget="row" data-spacing="aaaa" style="background-color:rgba(0, 0, 0, 0.5);" data-bg-position="left top">
...
<div data-widget-id="wid_1556093382_fqj2vqqbj" class="moto-widget moto-widget-image moto-preset-default moto-align-center moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small  " data-widget="image">
                ...
                <img data-src="images/mt-1806-icon01.png" class="moto-widget-image-picture lazyload" data-id="161" title="" alt="">
            </span>
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_9">24/7/365 SUPPORT</p></div>
</div>
...
<div class="moto-widget moto-widget-row row-gutter-0 moto-justify-content_center moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-grid-type="xs" data-widget="row" data-spacing="sasa" style="" data-bg-position="left top">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div data-widget-id="wid_1556093445_pj4t845iu" class="moto-widget moto-widget-image moto-preset-default moto-align-center moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small  " data-widget="image">
                        <span class="moto-widget-image-link">
                <img data-src="images/mt-1806-icon02.png" class="moto-widget-image-picture lazyload" data-id="163" title="" alt="">
            </span>
            </div>
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_9">EXPERT ASSISTANCE</p></div>
</div>
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div data-widget-id="wid_1556093607_8udrge32h" class="moto-widget moto-widget-image moto-preset-default moto-align-center moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small  " data-widget="image">
                        <span class="moto-widget-image-link">
                <img data-src="images/mt-1806-icon03.png" class="moto-widget-image-picture lazyload" data-id="164" title="" alt="">
            </span>
            </div>
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="aaas" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_9">TRUSTED PARTNER</p></div>
</div>
...
<div data-widget-id="wid_1556093684_el17c8xb9" class="moto-widget moto-widget-spacer moto-preset-default moto-spacing-top-large moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto moto-visible-on_tablet"
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aama" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable">
        <!-- <p class="moto-text_system_11">OVERVIEW</p> -->
        <h2 class="moto-text_system_6">MY <strong>Outsourcing </strong>Limited</h2></div>
</div>
...
<p class="moto-text_normal">We value the latest technological developments to meet the growing needs of our customers. In that regard, we involve innovative techniques like call blending, voice logging, soft phone, IVR, ACD, dialer software and many more to offer improved service for our clients and meet their contact center/BPO outsourcing requirements.</p></div>
</div> -->
        ...
        <div class="row" data-container="container">
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-12 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable">
                        <!-- <p class="moto-text_system_14">What We Do</p><p class="moto-text_normal"><br></p> -->
                       
                        <p>MY Outsourcing Limited, a leading Contact Center service provider with extensive experience in working with the most MNC & FMCG companies in Bangladesh. Established in 2012 and a concern of MY Group of Companies .Specialize in offering extensive & comprehensive Contact Center  Services and Back Office Support With robust infrastructure. We value the latest technological developments to meet the growing needs of our customers. In this regard we have involved certain innovative techniques like that of call blending, voice logging, soft phone, IVR ACD, dialer software and more offer improved service for our clients and meeting their call center outsourcing requirements.</p>

                        <p>A strong combination of powerful technology and highly trained personnel, MY Outsourcing Limited completes in the global market, meeting the required standards and more by the industry.</p>

                        <p>MY Outsourcing Limited is ISO certified. We are also member of <b>BACCO & BASIS</b> . </p>
...
<div class="moto-widget moto-widget-row__column moto-cell col-sm-3 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
    ...
    <!-- [phyp[p[hjytpj]]] -->
    <p style="margin-top: 40px; text-align: justify; text-justify: inter-word;"><strong>MY Outsourcing Limited</strong> provides end-to-end customized business process optimization services across major business functions and industry verticals. With our skilled manpower, comprehensive industry knowledge and use of latest technologies and processes, we are best placed to help companies to achieve their goals. We provide order management services for businesses across industry verticals: manufacturing, ecommerce, retail, FMCG, automotive, logistics, energy and utilities, Information Technology (IT), banking, financial services and insurance (BFSI), electronics, education, government services, travel, leisure and hospitality, media and entertainment, healthcare, publishing, industrial goods and many more. We emphasize on increasing the profitability and the efficiency meeting needs of our diverse patrons. We follow globally-adopted best practices in our call center security operations which ensure that your data is secure with us. In fact, we help enterprises to assess their existing security policies while outsourcing and check for any vulnerability and help them in establishing robust security policies.</p>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-small moto-spacing-bottom-medium moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="msms" data-animation="">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-small moto-spacing-bottom-medium moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="msms" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h3 class="moto-text_system_13">Mobile APPs and Enterprise Solution</h3><p class="moto-text_normal">&nbsp;</p><p class="moto-text_normal"><span class="moto-color5_5">MY Outsourcing Ltd. develops Android & iOS Applications for various industry clients such as automobile, FMCG, Electronics industry, Hospitals, Activation Agency, Digital Payment gateway provider companies in Bangladesh.&nbsp;</span></p><p class="moto-text_normal">&nbsp;</p></div>
</div>
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aama" data-animation="">
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_normal"; style="text-align: justify; text-justify: inter-word;">MY Group of Companies, a renowned conglomerate dealing mainly with IT enabled products and services Since 2009, recently launched its latest venture -- MY Outsourcing Ltd – a BPO/Contact Center service provider with a vision to change the way people do business and serve their clients. It specializes in offering contact center services, Back Office Support With robust infrastructure. We manage all our projects as efficiently as possible with conviction. 


</p><p class="moto-text_normal"; style="text-align: justify; text-justify: inter-word;">We value the latest technological developments to meet the growing needs of our customers. In that regard, we involve innovative techniques like call blending, voice logging, soft phone, IVR, ACD, dialer software and many more to offer improved service for our clients and meet their contact center/BPO outsourcing requirements.</p></div>
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-6 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_14">What We Do</p><p class="moto-text_normal"; ><br></p>
                        ...
                        <p style="text-align: justify; text-justify: inter-word;">With more than 8 years of experience as a leading Call Center Outsourcing company, MY Outsourcing Limited enables you to delight your customers. Local and Multinational Companies of various industries in Bangladesh have utilized our multi-channel contact center to stay connected to their customers at all hours of the day. With our call center outsourcing services, your business can streamline the Customer Relationship Management (CRM) process to achieve a high rate of business growth and profitability.</p>
<p style="text-align: justify; text-justify: inter-word;">MY Outsourcing Limited has 24/7 Contact Centre for serving professional Back Office, Front Office and Offshore Outsourcing services to its corporate clients. We have also launched the Stealth Monitoring Service for the first time in Bangladesh, following its inception and popularity of such services in abroad.</p>
<p style="text-align: justify; text-justify: inter-word;">We have expert human resources to work as call center agents who are trained by our expert trainer who has working experience in the related industry.  Our agents are skilled to handle the customer’s inbound calls to serve them in expected manner and handle high volume of calls with increasing customer to business response time (FCR) or First Call Resolution. We ensure to provide the quality service to the customer end and eliminate gaps in customer service.</p>  

<p style="text-align: justify; text-justify: inter-word;">MY Outsourcing Ltd has been given employment opportunity for 40 disabled people in voice and non-voice sector. MY Outsourcing Limited has signed a tri party MoU with CSID (Center for Services and Information on Disability) and Sightsavers Bangladesh recently in the city. Under the agreement MYOL will provide the job opportunity for the disable people from CSID. My Outsourcing Limited Received Best Employer for Differently Abled Persons in Job Fair 2018 and also  Job Fair 2019 organized by ICT Division and Bangladesh Computer Council . 
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-6 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    ...
                    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_14">Confidentiality and Privacy</p><p class="moto-text_normal"><br></p>
                        ...
                        <p style="text-align: justify; text-justify: inter-word;">At MYOL, we are sensitive to customer concerns and ensure absolute confidentiality and privacy of any information that is given to us. Customers can specify their preferred mode of contact with us, and we will not disclose their identity without their express or written consent. </p>
                        <br>
                        <br>
                    ...
                    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_14">Proud Members</p><p class="moto-text_normal"><br></p>

                       
                       <p style="text-align: justify; text-justify: inter-word;">MY Outsourcing Limited is ISO certified. We are also member of <strong>BACCO</strong> & <strong>BASIS</strong>.</p>
                        <br>
...
<div class="moto-widget moto-widget-block moto-spacing-top-large moto-spacing-right-auto moto-spacing-bottom-large moto-spacing-left-auto" data-widget="block" data-spacing="lala" style="" data-bg-position="left top"><a class="moto-anchor" name="services"></a>
    ...
    <div class="moto-widget-text-content moto-widget-text-editable">
    	<!-- <p class="moto-text_system_11">WHAT WE DO</p> -->
    	<h2 class="moto-text_system_6">Our <strong>Services</strong></h2></div>
</div><div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-medium moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="amma" data-animation="" data-draggable-disabled="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_186" style="text-align: justify; text-justify: inter-word;">Inbound & Outbound Services, Sofware Development </p></div>
</div><div class="moto-widget moto-widget-container moto-container_content_5cc02b3f2" data-widget="container" data-container="container" data-css-name="moto-container_content_5cc02b3f2" data-bg-position="left top">
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-medium moto-spacing-bottom-medium moto-spacing-left-medium" data-widget="text" data-preset="default" data-spacing="mmmm" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_7">Features of Inbound & Outbound Services</p><p class="moto-text_186">&nbsp;</p><p class="moto-text_186" style="text-align: justify; text-justify: inter-word;">We provide dynamic and flexible solutions for your customer care in inbound segment. We provide a plethora of benefits for your company to likely increase customer satisfaction</p><p class="moto-text_186">&nbsp;</p>
    <ul>
        <li class="moto-text_186">Customer Care and Support</li>
        <li class="moto-text_186">Enquiry Support</li>
        <li class="moto-text_186">Telemarketing Service</li>
        <li class="moto-text_186">Order talking/Processing</li>
        <li class="moto-text_186">Lead Generation</li>
        <li class="moto-text_186">Technical Support</li>
        <li class="moto-text_186">Software Development</li>
        <li class="moto-text_186">Product Launching Information</li>
        <li class="moto-text_186">Registration and Event Hotline Service</li>
        <li class="moto-text_186">Customer Satisfaction Survey</li>
        <li class="moto-text_186">Account Management</li>
        <li class="moto-text_186">Appointment Setting</li>
        <li class="moto-text_186">Credit Card Collections</li>
        <li class="moto-text_186">Credit Card Acquisition</li>
        <li class="moto-text_186">Retention</li>
        <li class="moto-text_186">Catalog/Order Entry</li>
        <li class="moto-text_186">Data Validation</li>
        <li class="moto-text_186">Survey Calls</li>
        <li class="moto-text_186">Credit Collection Calls</li>
    </ul></div>
</div><div data-widget-id="wid_1556098614_3st6w90di" class="moto-widget moto-widget-spacer moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto moto-visible-on_desktop"
    data-widget="spacer" data-preset="default" data-spacing="aaaa" data-visible-on="desktop">
    <div class="moto-widget-spacer-block" style="height:67px"></div>
</div></div>
...
<div class="moto-widget moto-widget-row row-gutter-0 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-grid-type="xs" data-widget="row" data-spacing="aaaa" style="" data-bg-position="left top">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div data-widget-id="wid_1556098164_xvon3cxng" class="moto-widget moto-widget-divider moto-preset-2 moto-align-left moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="divider_horizontal" data-preset="2">
    <hr class="moto-widget-divider-line" style="max-width:100%;width:100%;">
</div>
...
<div class="moto-widget moto-widget-row moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-large moto-spacing-left-auto" data-grid-type="xs" data-widget="row" data-spacing="aala" style="" data-bg-position="left top">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
                    ...
                    <div class="moto-widget moto-widget-row__column moto-cell col-xs-7 moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" style="background-color:rgba(0, 0, 0, 0.7);" data-widget="row.column" data-container="container" data-spacing="sasa" data-bg-position="left top">
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_13">INBOUND CALL CENTER SERVICES</p>
        <p style="color: #fff;">We provide dynamic and flexible solutions for your customer care in inbound segment. We provide a plethora of benefits for your company to likely increase customer satisfaction.  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
    </div>
</div>
...
</div><div data-widget-id="wid_1556098380_4j2na6pu2" class="moto-widget moto-widget-spacer moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto "
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div data-widget-id="wid_1556098330_j2hug30rj" class="moto-widget moto-widget-divider moto-preset-2 moto-align-left moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="divider_horizontal" data-preset="2">
    <hr class="moto-widget-divider-line" style="max-width:100%;width:100%;">
</div>
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-small moto-spacing-bottom-small moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="ssss" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable">
        <p class="moto-text_system_13">OUTBOUND CALL CENTER SERVICES</p>
        <p style="color: #fff;">We provide top-notch outbound call center services to customers on behalf of a business or client. Calls made from the center includes telemarketing sales, credit collection calls, survey calls, data validation calls, lead generation calls.</p>
    </div>
</div>
...
</div><div data-widget-id="wid_1556098384_b87g5iog1" class="moto-widget moto-widget-spacer moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto "
    data-widget="spacer" data-preset="default" data-spacing="aaaa" data-visible-on="mobile-v">
    <div class="moto-widget-spacer-block" style="height:55px"></div>
</div>
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div data-widget-id="wid_1556098388_rdb10wqk5" class="moto-widget moto-widget-divider moto-preset-2 moto-align-left moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="divider_horizontal" data-preset="2">
    <hr class="moto-widget-divider-line" style="max-width:100%;width:100%;">
</div>
            ...
            <div class="moto-widget moto-widget-row row-gutter-0 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-grid-type="sm" data-widget="row" data-spacing="aaaa" style="background-image:url(images/mt-1806-img08.jpg);background-position:top;background-repeat:no-repeat;background-size:cover;" data-bg-image="images/mt-1806-img11.jpg" data-bg-position="top">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-small moto-spacing-bottom-small moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="ssss" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable">
        <p class="moto-text_system_13">VIDEO SURVEILLANCE MONITORING</p>
        <p style="color: #fff;">At our Live Video Surveillance Monitoring Service, we are your eyes- watching over your property and assets remotely 24/7 to ensure complete security. Unlike physical uniform or patrol guard services, we never take a break or fall asleep.</p>
    </div>
</div>
            ...
            <div data-widget-id="wid_1556098388_05ahvj1m0" class="moto-widget moto-widget-spacer moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto "
    data-widget="spacer" data-preset="default" data-spacing="aaaa" data-visible-on="mobile-v">
    <div class="moto-widget-spacer-block" style="height:55px"></div>
</div>
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div data-widget-id="wid_1556098388_255cdfo55" class="moto-widget moto-widget-divider moto-preset-2 moto-align-left moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="divider_horizontal" data-preset="2">
    <hr class="moto-widget-divider-line" style="max-width:100%;width:100%;">
</div>
            ...
            <div class="moto-widget moto-widget-row row-gutter-0 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-grid-type="sm" data-widget="row" data-spacing="aaaa" style="background-image:url(images/service4.jpg);background-position:top;background-repeat:no-repeat;background-size:cover;" data-bg-image="images/mt-1806-img09.jpg" data-bg-position="top">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-small moto-spacing-bottom-small moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="ssss" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable">
        <p class="moto-text_system_13">NON-VOICE AND BACK OFFICE SUPPORT</p>
        <p style="color: #fff;">We provide Non-Voice and Back-office services in order to ensure an experience that is seamless for your customer and increasingly efficient and effective for your business. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
    </div>
</div>
            ...
            <div data-widget-id="wid_1556098388_h52agag22" class="moto-widget moto-widget-spacer moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto "
    data-widget="spacer" data-preset="default" data-spacing="aaaa" data-visible-on="mobile-v">
    <div class="moto-widget-spacer-block" style="height:55px"></div>
</div>
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div data-widget-id="wid_1556098390_edagf22fi" class="moto-widget moto-widget-divider moto-preset-2 moto-align-left moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="divider_horizontal" data-preset="2">
    <hr class="moto-widget-divider-line" style="max-width:100%;width:100%;">
</div>
            ...
            <div class="moto-widget moto-widget-row row-gutter-0 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-grid-type="sm" data-widget="row" data-spacing="aaaa" style="background-image:url(images/service5.jpg);background-position:top;background-repeat:no-repeat;background-size:cover;" data-bg-image="images/mt-1806-img10.jpg" data-bg-position="top">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-small moto-spacing-bottom-small moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="ssss" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable">
        <p class="moto-text_system_13">DATA MANAGEMENT</p>
        <p style="color: #fff;">Access to accurate data is necessary for effective investment decisions, trade execution, securities pricing, risk management, regulatory compliance, and portfolio valuation and measurement. We have been helping capital markets leaders achieve high performance through effective data management solutions for more than 5 years.</p>
    </div>
</div>
            ...
            <div data-widget-id="wid_1556098390_c9tdvczrx" class="moto-widget moto-widget-spacer moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto "
    data-widget="spacer" data-preset="default" data-spacing="aaaa" data-visible-on="mobile-v">
    <div class="moto-widget-spacer-block" style="height:55px"></div>
</div>
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div data-widget-id="wid_1556098390_vndvcwfec" class="moto-widget moto-widget-divider moto-preset-2 moto-align-left moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto  " data-widget="divider_horizontal" data-preset="2">
    <hr class="moto-widget-divider-line" style="max-width:100%;width:100%;">
</div>
            ...
            <div class="moto-widget moto-widget-row row-gutter-0 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-grid-type="sm" data-widget="row" data-spacing="aaaa" style="background-image:url(images/mt-1806-img09.jpg);background-position:top;background-repeat:no-repeat;background-size:cover;" data-bg-image="images/mt-1806-img08.jpg" data-bg-position="top">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-small moto-spacing-right-small moto-spacing-bottom-small moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="ssss" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable">
        <p class="moto-text_system_13">VALUE ADDED SERVICE</p>
        <p style="color: #fff;">Our in-house Voice Broadcasting system broadcasts to potentials. Potential customers will listen to an automated voice message detailing your offer/service and If interested select a key as their preference. Our VB system will filter the broadcasting reports regarding customers’ preference.</p>
    </div>
</div>
...
</div><div data-widget-id="wid_1556098390_wbzd24730" class="moto-widget moto-widget-spacer moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto "
    data-widget="spacer" data-preset="default" data-spacing="aaaa" data-visible-on="mobile-v">
    <div class="moto-widget-spacer-block" style="height:55px"></div>
</div>
    ...
    <div class="moto-widget-callback__wrapper">
        ...
        <div class="moto-widget-callback__body moto-widget-callback__body_more-details-enabled" style="display: none;">
            ...
            <div class="moto-widget-callback__description moto-widget-text">
                <p class="moto-text_system_8" style="text-align: center;"><span class="moto-color_custom1">Front Desk</span></p>
                <!-- <p class="moto-text_normal" style="text-align: center;">Front Desk</p> -->
                <p class="moto-text_normal" style="text-align: center;"><a class="moto-link" data-action="call" href="tel:+8809610223344"><span class="fa"></span> +8809610223344</a></p>            </div>
...
<script src="js/website.assets.min.js?_build=1556311539" type="text/javascript" data-cfasync="false"></script>
    ...
    <script type="text/javascript" src="js/touch-slider.js"></script>
