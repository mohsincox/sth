...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aama" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_11"><!-- Our Solutions --></p><h2 class="moto-text_system_6">DATA <strong>MANAGEMENT </strong> SOLUTIONS</h2></div>
     ...
     <p style="text-align: justify; text-justify: inter-word;">At our Live Video Surveillance Monitoring Service, we are your eyes- watching over your property and assets remotely 24/7 to ensure complete security. Unlike physical uniform or patrol guard services, we never take a break or fall asleep.</p>
                        <br>
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-6 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 0px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable"><!-- <p class="moto-text_system_14">What We Do</p><p class="moto-text_normal"><br></p> -->
                        ...
                        <p style="text-align: justify; text-justify: inter-word;">Database Management Solution provides deep-dive performance monitoring and Database creation & Storing from 500+ users located in a single location or remote locations all over the country. Additionally, it tracks consumer experience on the product or service followed by complete consumer profiling which can be easily filtered and sorted by the marketing team for targeting the consumers for various marketing & promotion campaigns.</p></br>
<p style="text-align: justify; text-justify: inter-word;">The data entry field force performance can also be evaluated from the database generated and entered in the Database management solution. More than 5000 businesses around the world use this type of Solution to quickly detect, isolate and resolve business performance issues, effectively plan capacity & and targeting every specific group of consumers/customers from the database and ensure optimal performance of their applications. This Solution can be hosted in a physical server or cloud server as per client’s requirement. </p></br>
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-6 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 0px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                   <!--  <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_14">Infrastructure and security</p><p class="moto-text_normal"><br></p> -->
                      ...
                      <img src="images/data.jpg" align="right" ><p class="moto-text_normal"></p>
