...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aama" data-animation="">
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-12 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable">
                    	...
                    	<img src="images/database.jpg"><p class="moto-text_normal"><br></p>
                       
                        <p>Database Management Solution provides deep-dive performance monitoring and Database
                        Creation & Storing from 500+ users located in a single location or remote locations all over the
                        country. Additionally, it tracks consumer experience on the product or service followed by complete
                        consumer profiling which can be easily filtered and sorted by the marketing team for targeting the
                        consumers for various marketing & promotion campaigns. The data entry field force performance can
                        also be evaluated from the database generated and entered in the Database Management Solution.</p>
                        <br>
                    ...
                    <!-- <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_14">iTracker Core Capabilities:</p><p class="moto-text_186">&nbsp;</p>
    ...
    <ul>
        <li class="moto-text_186">Web based Tracking System</li>
        <li class="moto-text_186">Easy Integration with iDialer & iCRM</li>
        <li class="moto-text_186">Full Escalation History (Assign & transfer)</li>
        <li class="moto-text_186">Rich Text Editor for Campaign Description</li>
        <li class="moto-text_186">File Attachment</li>
        <li class="moto-text_186">Organizational Hierarchy Based Ticket Allocation</li>
        <li class="moto-text_186">Detailed Reporting Module</li>
        <li class="moto-text_186">Ticket Forwarding & Receipt Facility</li>
        <li class="moto-text_186">User-Group Transfer</li>
        <li class="moto-text_186">Integrated with Email & SmS Gateway</li>
