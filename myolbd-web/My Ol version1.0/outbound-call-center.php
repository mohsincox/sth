            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-12 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable">
                          ...
                          <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_11"><!-- Our Solutions --></p><h2 class="moto-text_system_6">Outbound <strong> Call </strong>Center</h2></div></br></br>
                       ...
                       <p style="text-align: justify; text-justify: inter-word;">We provide top-notch outbound call center services to customers on behalf of a business or client. Calls made from the center includes telemarketing sales, credit collection calls, survey calls, data validation calls, lead generation calls.  </p>
                        <br>
                ...
                <ul>
                    <li class="moto-text_186">Outbound Customer Support</li>
                    <li class="moto-text_186">24/7 or Overflow Call Center</li>
                    <li class="moto-text_186">Lead Generation</li>
                    <li class="moto-text_186">Sales</li>
                    <li class="moto-text_186">Appointment Setting</li>
                    <li class="moto-text_186">Surveys</li>
                    <li class="moto-text_186">Market Research</li>
                    <li class="moto-text_186">Collections</li>
                    ...
                    <div class="col-sm-6">
                          <img src="images/out.jpg"  ><p class="moto-text_normal"></p>
                    </div>
                </div>
