...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aama" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_system_6" style="text-align: center;">Brand  <strong>Promotion </strong> Training</h2></div>
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-4 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable"><!-- <p class="moto-text_system_14">What We Do</p> --><p class="moto-text_normal"><br></p>
                        ...
                        <p style="text-align: justify; text-justify: inter-word;">MY Outsourcing Limited offered Brand Promotion Training to help prepare ideas about launching a brand successfully, understanding of brand positioning clearly, Identifying the mistakes of Branding & ways to overcome them, Managing brands more effectively, etc.</br></br>

                       Brand Promoting Training Program provides a detailed understanding about Introduction to the concept of brands and brand management, Consumer-based brand equity, Brand positioning and value. Designing and building brand equity. Integrating marketing communications to brand equity. Sources of brand equity- its measurement and management. Designing and implementing branding strategies. Brand extensions, managing brands over time.</p></br>
...
<!-- 
        ...
        <li class="moto-text_186">Facebook Link: facebook.com/myoltraining/</li>
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-8 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    ...
                    <div class="moto-widget-text-content moto-widget-text-editable"><!-- <p class="moto-text_system_14">Infrastructure and security</p> --><p class="moto-text_normal"><br></p>
                         ...
                         <img src="images/brand2.jpg"  ><p class="moto-text_normal"></p>
