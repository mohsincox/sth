            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-12 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable">
                    	<h2 class="moto-text_system_6" style="text-align: center;">Mobile Apps and <strong>Enterprise</strong> Solutions:</h2>
                    	<!-- <p class="moto-text_system_14">Mobile Apps and Enterprise Solutions:</p> -->
                    	<!-- <img src="images/mobile_apps.jpg" width="500" height="600"><p class="moto-text_normal"><br></p> -->
                       
                        <p>Android application is becoming very popular nowadays in the corporate sector where B2B and B2C communications are getting easier with fruitful outcomes identified for the specific business through this medium. MYOL develops Android & iOS Applications for various industry clients such as automobile, FMCG, Electronics industry, Hospitals, Activation Agency, Digital Payment gateway provider companies in Bangladesh.</p>
                        <br>
