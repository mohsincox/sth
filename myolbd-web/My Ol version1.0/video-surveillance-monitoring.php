...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aama" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_11"><!-- Our Solutions --></p><h2 class="moto-text_system_6">VIDEO   <strong>SURVEILLANCE </strong> MONITORING</h2> <br></div>
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-5 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 0px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable"><!-- <p class="moto-text_system_14">What We Do</p><p class="moto-text_normal"><br></p> -->
                        ...
                        <p style="text-align: justify; text-justify: inter-word;"><strong>Real-time monitoring: </strong>  You will get your site monitored 24/7 in real-time by our e-surveillance professionals. They will raise alerts the moment they detect any criminal
                        activity or anything out of the ordinary.</br></br>
                        <strong>Multiple site view:</strong> You get the convenience of having your multiple locations monitored from our centralized control room. No matter where these locations are, we can keep an eye on them.</br></br>
                         <strong>2-way Communication system:</strong> Using our 2-way communication system, in the event of a crime, our e-surveillance professionals can communicate to the criminal that he has been caught on camera and the police called, hence deterring the crime.</br></p>
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-7 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 0px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                   <!--  <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_14">Infrastructure and security</p><p class="moto-text_normal"><br></p> -->
                      ...
                      <img src="images/pbx.jpg" align="right" ><p class="moto-text_normal"></p>
