...
<div class="moto-widget moto-widget-block moto-spacing-top-large moto-spacing-right-auto moto-spacing-bottom-large moto-spacing-left-auto" data-widget="block" data-spacing="lala" style="" data-bg-position="left top"><a class="moto-anchor" name="offers"></a>
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_11" style="text-align: center;">WHAT WE OFFER</p><h2 class="moto-text_system_6" style="text-align: center;">Our <strong>Solutions</strong></h2></div>
</div><div class="moto-widget moto-widget-row row-fixed moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-grid-type="sm" data-widget="row" data-spacing="aaaa" style="" data-bg-position="left top">
...
<!-- <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aama" data-animation="">
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-12 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable">
                          ...
                          <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_11"><!-- Our Solutions --></p><h2 class="moto-text_system_6">Interactive <strong> Voice  </strong>Response</h2></div></br></br>
                        ...
                        <!-- <p class="moto-text_system_14">IDIALER</p> -->
                        <!-- <img src="images/ipbx.png"><p class="moto-text_normal"><br></p> -->
                       
                        <!-- <p style="text-align: justify; text-justify: inter-word;">MY outsourcing Ltd. working with converged communication system also offers value added service to clients to enhance effective CONTACT CENTER SERVICE OPERATION and initiate effective CONSUMERS communication through this module. This would help clients in mass level communication on awareness and collecting feedback from consumers. This generates detail analysis report as per client requirement.</p>
                        <br> -->
    ...
    <ul>
        <li class="moto-text_186">IVR broadcasting is a mass communication technique that broadcasts telephone messages to hundreds or thousands of call recipients at once.</li>
        <li class="moto-text_186">Interactive voice broadcasting (also referred  to as interactive voice messaging) programs  allow the call recipient to listen to the  recorded message and interact with the  system by pressing keys on the phone  keypad</li>
        <li class="moto-text_186">MYOL is maintaining a wide variety of segmented database to facilitate its clients through IVR Broadcasting.</li>
<!--         <li class="moto-text_186">Voice Recording</li>
        <li class="moto-text_186">Auto Attendant with Interactive Voice Response</li>
        <li class="moto-text_186">Call Hold , Transfer , Waiting , Park</li>
        <li class="moto-text_186">Three-way Conferencing</li>
        <li class="moto-text_186">Voice Mail</li>
        <li class="moto-text_186">Call Blocking</li>
        <li class="moto-text_186">Do Not Disturb</li>
        <li class="moto-text_186">Call Forwarding</li>
        <li class="moto-text_186">Call Statistics Report (inbound/outbound call detail ,length of call, on-hold time etc.)</li>
        <li class="moto-text_186">Call Routing</li> -->
