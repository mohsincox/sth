...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aama" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_11"><!-- Our Solutions --></p><h2 class="moto-text_system_6">DATA <strong>MANAGEMENT </strong>SOLUTIONS</h2></div>
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_normal"; style="text-align: justify; text-justify: inter-word;">Database Management Solution provides deep-dive performance monitoring and Database creation & Storing from 500+ users located in a single location or remote locations all over the country. 
    Additionally, it tracks consumer experience on the product or service followed by complete consumer profiling which can be easily filtered and sorted by the marketing team for targeting the consumers for various marketing & promotion campaigns. </br></br>
    The data entry field force performance can also be evaluated from the database generated and entered in the Database management solution.
    More than 5000 businesses around the world use this type of Solution to quickly detect, isolate and resolve business performance issues, effectively plan capacity & and targeting every specific group of consumers/customers from the database and ensure optimal performance of their applications. This Solution can be hosted in a physical server or cloud server as per client’s requirement


</p></br>
<!-- <div class="moto-widget-text-content moto-widget-text-editable">
<img src="images/wfm.jpg" style="align: center" ><p class="moto-text_normal"></p>
</div></br>
<p class="moto-text_normal">Workforce management is an institutional process that maximizes performance levels and competency for an organization. The process includes all the activities needed to maintain a productive workforce, such as field service management, human resource management, performance and training management, data collection, recruiting, budgeting, forecasting, scheduling and analytics. </p></div>
</br> -->
