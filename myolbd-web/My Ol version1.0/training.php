...
<div class="moto-widget moto-widget-block moto-spacing-top-large moto-spacing-right-auto moto-spacing-bottom-large moto-spacing-left-auto" data-widget="block" data-spacing="lala" style="" data-bg-position="left top"><a class="moto-anchor" name="offers"></a>
    ...
    <div class="moto-widget-text-content moto-widget-text-editable">
        ...
        <h2 class="moto-text_system_6" style="text-align: center;">Training</h2>
    </div>
</div>
<div class="moto-widget moto-widget-row row-fixed moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-grid-type="sm" data-widget="row" data-spacing="aaaa" style="" data-bg-position="left top">
...
<div class="moto-widget moto-widget-row__column moto-cell col-sm-3 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
    ...
    <br>
    <br>
    <p style="text-align: justify; text-justify: inter-word;"><strong>Leadership</strong> is the ability to influence a group toward the achievement of goals and management is use of authority inherent in designated formal rank to obtain compliance from organizational members. In order to train prospective leaders to use appropriate tools and techniques of leadership and management, the following training course has been offered by MY Outsourcing Limited.</p>
...
</div><div class="moto-widget moto-widget-container moto-container_content_seip" data-widget="container" data-container="container" data-css-name="moto-container_content_seip" data-bg-position="center">
...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-small moto-spacing-bottom-medium moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="msms" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h3 class="moto-text_system_13">SEIP Training</h3><p class="moto-text_normal">&nbsp;</p><p class="moto-text_normal"; style="text-align: justify; text-justify: inter-word;"><span class="moto-color5_5"; >MY OUTSOURCING LTD is offering a FREE Certificate Training course in order to create skilled resources within the sector for Call Center/ Business Process Outsourcing (BPO) under the Project of Skills for Employment Investment Program (SEIP).&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p><p class="moto-text_normal">&nbsp;</p><p class="moto-text_normal">&nbsp;</p></div>
</div></div><div class="moto-widget moto-widget-row__column moto-cell col-xs-2 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
    ...
    <hr class="moto-widget-divider-line" style="max-width:100%;width:100%;">
            ...
            <div class="moto-widget moto-widget-container moto-container_content_soft_skill" data-widget="container" data-container="container" data-css-name="moto-container_content_soft_skill" data-bg-position="center">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-small moto-spacing-bottom-medium moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="msms" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h3 class="moto-text_system_13">Soft Skill Training</h3><p class="moto-text_normal">&nbsp;</p><p class="moto-text_normal" style="margin-bottom: 38px; text-align: justify; text-justify: inter-word;"><span class="moto-color5_5">Our mission is to transform human resources, predominantly youth to skilled professionals to improve lives & changing people’s working pattern by providing soft skill training to make a huge impact on building strong profession.</span></p></div>
</div>
    ...
    <hr class="moto-widget-divider-line" style="max-width:100%;width:100%;">
            ...
            <div class="moto-widget moto-widget-container moto-container_content_brand_promotion" data-widget="container" data-container="container" data-css-name="moto-container_content_brand_promotion" data-bg-position="center">
    ...
    <div class="container-fluid">
        <div class="row" data-container="container">
            ...
            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-small moto-spacing-bottom-medium moto-spacing-left-small" data-widget="text" data-preset="default" data-spacing="msms" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h3 class="moto-text_system_13">Brand Promotion Training</h3><p class="moto-text_normal">&nbsp;</p><p class="moto-text_normal"; style="text-align: justify; text-justify: inter-word;"><span class="moto-color5_5">MY Outsourcing Limited offered Brand Promotion Training to help prepare ideas about launching a brand successfully, understanding of brand positioning clearly, Managing brands more effectively, etc.&nbsp;</span></p><p class="moto-text_normal">&nbsp;</p></div>
</div>
