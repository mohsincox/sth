...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aama" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_11"><!-- Our Solutions --></p><h2 class="moto-text_system_6">SMS  <strong>Broadcast  </strong>Solutions</h2></div>
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-12 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable"><!-- <p class="moto-text_system_14">What We Do</p><p class="moto-text_normal"><br></p> -->
                        ...
                        <p style="text-align: justify; text-justify: inter-word;">My Outsourcing Limited is providing various SMS based VAS services to different segments of subscribers ranging from corporate to individual subscribers and covering almost all operators in Bangladesh .SMS Burst (Masking/Non Masking) is a mass communication technique,that sends messages to hundreds or thousands of recipients at once. MYOL also avails the push-pull SMS services for its clients which can be used for SMS registration/SMS quiz competition/inquiry/ Getting audience opinion. SMS is most effective tools for Marketing Communication, Product Promotion or Alert/Notification; we have huge number of segmented customer database for opt in communication.</p>
<!-- <p style="text-align: justify; text-justify: inter-word;">Workforce management is an institutional process that maximizes performance levels and competency for an organization. The process includes all the activities needed to maintain a productive workforce, such as field service management, human resource management, performance and training management, data collection, recruiting, budgeting, forecasting, scheduling and analytics. </p> -->
...
<div class="row">
    <div class="col-sm-6">
        <div class="moto-widget-text-content moto-widget-text-editable"><!-- <p class="moto-text_system_14">IVR (Interactive Voice Response): </p> --><p class="moto-text_186">&nbsp;</p>
                        <!-- <p style="text-align: justify; text-justify: inter-word;">IVR (Interactive Voice Response) System is an automated interaction with telephone callers, gathers information and routes calls to the appropriate recipients .Pre-recorded voice prompts are used to present information and options to callers and phone keypad entry to collect their responses. My Outsourcing Limited design this System for helps to reduce the cost of common sales, service, collections, inquiry and support calls to and from your company. </p> -->
                        <p class="moto-text_186">&nbsp;</p>
    <ul>
        <li class="moto-text_186"> Product Marketing</li>
        <li class="moto-text_186"> Brand Promotion</li>
        <li class="moto-text_186"> Greetings to clients</li>
        <li class="moto-text_186"> Booking Alerts</li>
        <li class="moto-text_186"> Awareness messaging</li>
        <li class="moto-text_186"> Event Promotion</li>
        <li class="moto-text_186"> Web 2 SMS</li>
        <li class="moto-text_186"> Meeting Notification</li>
        <li class="moto-text_186"> Customer Notification</li>
        <li class="moto-text_186"> Any kinds of Alert / Notification services</li>
        <li class="moto-text_186"> SMS to millions in a single click</li>
        <li class="moto-text_186"> Schedule your SMS </li>
        <li class="moto-text_186"> Supports all Mobile Operators in Bangladesh</li>
        
    </ul>
</div>
    </div>
    <div class="col-sm-6">
          <img src="images/sms.png"  ><p class="moto-text_normal"></p>
    </div>
</div>
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-4 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 5px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
