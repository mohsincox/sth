            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-12 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable">
                          ...
                          <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_11"><!-- Our Solutions --></p><h2 class="moto-text_system_6">Inbound <strong> Call </strong>Center</h2></div></br></br>
                       ...
                       <p style="text-align: justify; text-justify: inter-word;">We provide dynamic and flexible solutions for your customer care in inbound segment. We provide a plethora of benefits for your company to likely increase customer satisfaction.<br>Inbound customer support is only one of the services our company has to offer. Advertise your products via telemarketing. Let our professionals call people, tell them all about your service, and persuade them that it is exactly what they need right now.  </p>
                        <br>
                ...
                <ul>
                    <li class="moto-text_186">Inbound Customer Support</li>
                    <li class="moto-text_186">24/7 or Overflow Call Center</li>
                    <li class="moto-text_186">Order Processing</li>
                    <li class="moto-text_186">Marketing Support</li>
                    <li class="moto-text_186">New Customer Acquisition</li>
                    <li class="moto-text_186">Helpdesk</li>
                    <li class="moto-text_186">Disaster Recovery</li>
                    ...
                    <div class="col-sm-6">
                          <img src="images/inb2.jpg"  ><p class="moto-text_normal"></p>
                    </div>
                </div>
