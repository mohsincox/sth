            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-12 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable">
                    	...
                    	<img src="images/idialer.png"><p class="moto-text_normal"><br></p>
                       
                        <p>iDialer is a Contact Center Software with complete functionality for inbound, outbound and blended campaigns. The all-inclusive solutions for contact centers are ideal for different business processes such as Customer support, Telemarketing and Sales, Collections, Technical support, Marketing research and Helpdesk.</p>
                        <br>

                        <p>iDialer ‘s open-software based architecture allows seamless integration with existing systems and easy scalability allowing easy migration to the next level . Easy to use GUI based interface that simplifies call routing & treatment, reporting, recording and administration. The IP-based voice and data communication solutions offer complete flexibility and adaptability to fit your organization.</p>
                        
                        <br>
                       
                    </div>
                    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_14">iDialer Core Capabilities:</p><p class="moto-text_186">&nbsp;</p>
                    	<!-- <p class="moto-text_186">We provide dynamic and flexible solutions for your customer care in inbound segment. We provide a plethora of benefits for your company to likely increase customer satisfaction</p> -->
                    	<p class="moto-text_186">&nbsp;</p>
    <ul>
        <li class="moto-text_186">ACD (Automatic Call Distributor)</li>
        <li class="moto-text_186">IVR (Interactive Voice Response )</li>
        <li class="moto-text_186">Predictive Dialer</li>
        <li class="moto-text_186">Voice Logger</li>
        <li class="moto-text_186">Detail Reporting</li>
        <li class="moto-text_186">Real Time Monitoring Dashboard</li>
