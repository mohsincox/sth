...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aama" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_11"><!-- Our Solutions --></p><h2 class="moto-text_system_6"><strong>Non-Voice </strong> & <strong>Back Office</strong> Support</h2></div>
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-6 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 0px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable"><!-- <p class="moto-text_system_14">What We Do</p><p class="moto-text_normal"><br></p> -->
                        ...
                        <p style="text-align: justify; text-justify: inter-word;">We provide Non-Voice and Back-office services in order to ensure an experience that is seamless for your customer and increasingly efficient and effective for your business.</br></br>Non-voice processes actually entail activities like email marketing, making reports, processing of papers as well as several other activities where the agents are not required to speak to clients/customers. At Fusion BPO Services we train our representatives for the non-voice processes by nurturing their other skills apart from the speech skills.</br></br>Back Office support allows you to outsource semi-standardized tasks like email and chat support, documentation, data mining, research and report writing, presentation preparation, bookkeeping, financial analysis, website development and support, etc. to an offshore team.</p></br>
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-6 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 0px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                   <!--  <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_14">Infrastructure and security</p><p class="moto-text_normal"><br></p> -->
                      ...
                      <img src="images/back.png"  ><p class="moto-text_normal"></p>
