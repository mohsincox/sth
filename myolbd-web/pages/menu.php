...
<div data-widget-id="wid_1556093002_yp649hvmt" class="moto-widget moto-widget-menu moto-preset-default moto-align-right moto-align-center_mobile-h moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-preset="default" data-widget="menu">
    ...
    <a href="solution.php"   data-action="url" class="moto-widget-menu-link moto-widget-menu-link-level-1 moto-widget-menu-link-submenu moto-link">Solutions<span class="fa moto-widget-menu-link-arrow"></span></a>
                <ul class="moto-widget-menu-sublist">
                    <li class="moto-widget-menu-item">
    <a href="solution-call-center.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">Contact Center Solutions</a>


                <ul class="moto-widget-menu-sublist">
                    <li class="moto-widget-menu-item">
    <a href="solution-call-center-idialer.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">iDialer</a>
        </li>

                    <li class="moto-widget-menu-item">
    <a href="solution-call-center-itracker.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">iTracker</a>
        </li>
                    <li class="moto-widget-menu-item">
    <a href="solution-call-center-icrm.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">iCRM</a>
        </li>
                    ...
                    <li class="moto-widget-menu-item">
    <a href="solution-ipbx.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">iPBX Solutions</a>
        </li>
                    <li class="moto-widget-menu-item">
    <a href="solution-mobile-apps.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">Mobile APPs and Enterprise Solutions</a>
        </li>
                    <li class="moto-widget-menu-item">
    <a href="wfm.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">Work Force Management</a>
        </li>
                    <li class="moto-widget-menu-item">
    <a href="data-managemet-solutions.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">Data Management Solutions</a>
        </li>
                    <li class="moto-widget-menu-item">
    <a href="ivr.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">IVR</a>
        </li>
                    <li class="moto-widget-menu-item">
    <a href="sms-broadcast.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">SMS Broadcast</a>
        </li>
                    <li class="moto-widget-menu-item">
    <a href="nps.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">NPS</a>
        </li>
    ...
    <a href="service.php"   data-action="url" class="moto-widget-menu-link moto-widget-menu-link-level-1 moto-widget-menu-link-submenu moto-link">Services<span class="fa moto-widget-menu-link-arrow"></span></a>
                <ul class="moto-widget-menu-sublist">
                    <li class="moto-widget-menu-item">
    <a href="inbound-call-center.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">Inbound Call Center Service</a>
        </li>
                    <li class="moto-widget-menu-item">
    <a href="outbound-call-center.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">Outbound Call Center Service</a>
        </li>
                    <li class="moto-widget-menu-item">
    <a href="non-voice-back-office.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">Non-voice & Back Office Support</a>
        </li>
        <li class="moto-widget-menu-item">
    <a href="vas.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">Value Added Services</a>
        </li>
        <!-- <li class="moto-widget-menu-item">
    <a href="service.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">Data Management</a>
        </li> -->
        <li class="moto-widget-menu-item">
    <a href="video-surveillance-monitoring.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">Video Surveillance Monitoring</a>
        </li>
            </ul>
        ...
        <li class="moto-widget-menu-item moto-widget-menu-item-has-submenu">
    <a href="training.php"   data-action="url" class="moto-widget-menu-link moto-widget-menu-link-level-1 moto-widget-menu-link-submenu moto-link">Training<span class="fa moto-widget-menu-link-arrow"></span></a>
                <ul class="moto-widget-menu-sublist">
                    <li class="moto-widget-menu-item">
    <a href="training-seip.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">SEIP Training</a>
        </li>
                    <li class="moto-widget-menu-item">
    <a href="training-soft-skill.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">Soft Skill Training</a>
        </li>
                    <li class="moto-widget-menu-item">
    <a href="training-brand-promotion.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-widget-menu-link-active moto-link">Brand Promotion Training</a>
        </li>
            </ul>
        ...
        <li class="moto-widget-menu-item">
            <a href="award.php"   data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-1 moto-widget-menu-link-active moto-link">Awards</a>
        </li>
