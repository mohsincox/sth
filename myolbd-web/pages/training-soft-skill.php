...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aama" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><h2 class="moto-text_system_6" style="text-align: center;">Soft <strong>Skill</strong> Training</h2></div>
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-5 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable"><!-- <p class="moto-text_system_14">What We Do</p> --><p class="moto-text_normal"><br></p>
                        ...
                        <p style="text-align: justify; text-justify: inter-word;">Our mission is to transform human resources, predominantly youth to skilled professionals to improve lives & changing people’s working pattern by providing soft skill training to make a huge impact on building strong profession. We aim to transform the obstacles towards proper education and youth unemployment.</br></br>

                        We bridge the gap between the manpower and local workforce as well as the skill gap between supply and demand. We provide affordable skill development solutions in Dhaka. We believe in a borderless world with equal opportunities for everyone.</p></br>
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-7 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    ...
                    <div class="moto-widget-text-content moto-widget-text-editable"><!-- <p class="moto-text_system_14">Infrastructure and security</p> --><p class="moto-text_normal"><br></p>
                         ...
                         <img src="images/soft2.png" align="right"  ><p class="moto-text_normal"></p>
