...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aama" data-animation="">
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_11"></p><h2 class="moto-text_system_6">SEIP <strong> Training </strong></h2></div>
    ...
    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_normal"; style="text-align: justify; text-justify: inter-word;">MY OUTSOURCING LTD is offering a FREE Certificate Training course in order to create skilled resources within the sector for Call Center/ Business Process Outsourcing (BPO) under the Project of Skills for Employment Investment Program (SEIP).
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-5 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable"><!-- <p class="moto-text_system_14">What We Do</p> --><p class="moto-text_normal"><br></p>
                        ...
                        <p style="text-align: justify; text-justify: inter-word;">Government of Bangladesh is planning to implement the Skills for Employment Investment Program (SEIP) with financial assistance from the Asian Development Bank (ADB) and Swiss Agency for Development and Cooperation (SDC) that will develop a workforce equipped with contemporary technical skills and knowledge through vocational training by establishing a mechanism to facilitate collaboration between training institutes and industry which would optimize the utilization of available human resources.</p></br>
<p style="text-align: justify; text-justify: inter-word;">The project is an integral part of the Government of Bangladesh (GoB), ADB and SDC- assisted Skills for Employment Investment Program (SEIP) (Phase 2). The program is designed to assist advance actions and initial implementation of the SEIP. The program will work in close coordination with the National Skill Development Council (NSDC) which is the apex institution for Skills Development in Bangladesh. The program will also work in close collaboration with a number of training institutes under different ministries, identified industry associations in priority sectors (garments and textiles, leather and leather goods, construction, light engineering, information technology, and shipbuilding), Bangladesh Bank Small and Medium Enterprise Department, and Palli-Karma Sahayak Foundation (PKSF).</p></br>
<p style="text-align: justify; text-justify: inter-word;">The program will have linkages with on-going projects supported by government and development partners including Skills Development Project, Skills Training Enhancement Project, etc. The Skills Development Coordination and Monitoring Unit (SDCMU) is being established under the Finance Division, Ministry of Finance to serve as the Program Management Unit (PMU) of the SEIP. Finance Division of the Ministry of Finance is the executing agency for the SEIP.</p> </br> 

<p style="text-align: justify; text-justify: inter-word;">MY Outsourcing Limited as an approved SEIP training partner which has been providing training as per SEIP rules, regulations and curriculum since November 2016. So far, we have conducted 45 batches consisting of 1594 (One thousand five hundred and ninety four) successful trainees. After completion of the program, MY Outsourcing Limited offer and allocate job opportunities to the trainees in gainful jobs in BPO sector or any other sector with relevant profession. 
        ...
        <p class="moto-text_system_14">Contact Us : </p><p class="moto-text_186">&nbsp;</p>
        <!-- <p class="moto-text_186">&nbsp;</p> -->

        <ul>
        <!-- <li class="moto-text_186">Skill Development Training Opportunity for FREE </li> -->
        <!-- <li class="moto-text_186">REGISTRATION FORM : https://goo.gl/forms/HJ90unCZaLEx1E8i2</li> -->
        <li class="moto-text_186">PROFESSIONAL CUSTOMER SERVICE & BACK OFFICE TRAINING PROGRAM</li>
        <li class="moto-text_186">TO BOOK YOUR SEAT CALL : +88-01711090779 or +88-01763097390</li>
        <li class="moto-text_186">E-Mail: seip@myolbd.com</li>
        <li class="moto-text_186">Address: House # 35 (5th Floor), Road # 7, Block # G, Banani, Dhaka 1213</li>
        <li class="moto-text_186">Facebook Link:<a href="https://www.facebook.com/myoltraining/" target="_blank"><font color="blue">&nbsp;&nbsp;&nbsp;&nbsp;Visit our Facebook Page</font></a></li>
        <!-- <li class="moto-text_186">CTI</li>
        <li class="moto-text_186">Voicemail</li>
        <li class="moto-text_186">Conferencing</li>
        <li class="moto-text_186">Remote Agent Access</li>
        <li class="moto-text_186">Dynamic Queuing</li>
        <li class="moto-text_186">Advance Lead Management</li>
        <li class="moto-text_186">Web Chat</li>
        <li class="moto-text_186">Quality Monitoring and Analytics</li>
        <li class="moto-text_186">CRM Integration</li>
        <li class="moto-text_186">Third Party Database Integration (MySQL, DB2, MSSQL, Oracle etc.)</li>
        <li class="moto-text_186">Back-up Data and Security</li> -->
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-7 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    ...
                    <div class="moto-widget-text-content moto-widget-text-editable"><!-- <p class="moto-text_system_14">Infrastructure and security</p> --><p class="moto-text_normal"><br></p>
                         ...
                         <img src="images/seip2.jpg"  ><p class="moto-text_normal"></p>
    ...
    <div class="moto-widget-callback__wrapper">
        ...
        <div class="moto-widget-callback__body moto-widget-callback__body_more-details-enabled" style="display: none;">
            ...
            <div class="moto-widget-callback__description moto-widget-text">
                <p class="moto-text_system_8" style="text-align: center;"><span class="moto-color_custom1">Front Desk</span></p><!-- <p class="moto-text_normal" style="text-align: center;">agent</p> --><p class="moto-text_normal" style="text-align: center;"><a class="moto-link" data-action="call" href="tel:+8809610223344"><span class="fa"></span> +8809610223344</a></p>            </div>
