...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-12 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable">
                          ...
                          <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_11"><!-- Our Solutions --></p><h2 class="moto-text_system_6">NET<strong> Promoter  </strong>Score </h2></div></br>
                        ...
                        <p style="text-align: justify; text-justify: inter-word;">Net Promoter or Net Promoter Score (NPS) is a management tool that can be used to gauge the loyalty of a firm's customer relationships. It serves as an alternative to traditional customer satisfaction research and is claimed to be correlated with revenue growth.
    ...
    <ul>
        <li class="moto-text_186"> Conducting survey over phone through IVR Platform.</li>
        <li class="moto-text_186"> Present summaries and analyses of survey data, including tables, graphs, and fact sheets.</li>
        <li class="moto-text_186"> Re-contacts those who initially refuse to participate in the survey to negotiate their participation.</li>
        <li class="moto-text_186"> Perform support services involving interactive voice enabled word processing, spreadsheet and database programs.</li>
<!--         <li class="moto-text_186"> Awareness messaging</li>
        ...
        <li class="moto-text_186"> Supports all Mobile Operators in Bangladesh</li> -->
                    ...
                    <div class="col-sm-6">
                          <img src="images/n.png"  ><p class="moto-text_normal"></p>
                    </div>
                </div>
