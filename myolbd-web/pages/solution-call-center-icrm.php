...
<div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aama" data-animation="">
            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-12 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable">
                    	...
                    	<img src="images/iCRM.jpg"><p class="moto-text_normal"><br></p>
                       
                        <p>iCRM is a dynamic CRM with multi-level integration capability. Multiple modules like product Management & Advanced Financial calculation can be added with CRM.</p>
                        <br>
                    ...
                    <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_14">iCRM Core Capabilities:</p><p class="moto-text_186">&nbsp;</p>
    ...
    <ul>
        <li class="moto-text_186">Customer Database</li>
        <li class="moto-text_186">Automatic information POPUP</li>
        <li class="moto-text_186">Conversation History tracking</li>
        <li class="moto-text_186">Dynamic search from profile data</li>
        <li class="moto-text_186">Purchase & service history</li>
        <li class="moto-text_186">Intelligent product suggestion</li>
        <li class="moto-text_186">Financial calculation</li>
        <li class="moto-text_186">Service & Product base statistical report</li>
        <li class="moto-text_186">Customer profiling & complex calculations</li>
        <li class="moto-text_186">Elaborate reporting module</li>
        <li class="moto-text_186">99.99% Uptime Center </li>
