            ...
            <div class="moto-widget moto-widget-row__column moto-cell col-sm-12 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                ...
                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-small" style="padding-top: 10px;" data-widget="text" data-preset="default" data-spacing="maas" data-animation="" data-draggable-disabled="">
                    <div class="moto-widget-text-content moto-widget-text-editable">
                          ...
                          <div class="moto-widget-text-content moto-widget-text-editable"><p class="moto-text_system_11"><!-- Our Solutions --></p><h2 class="moto-text_system_6">Value   <strong> Added </strong>Services</h2></div></br></br>
                       ...
                       <p style="text-align: justify; text-justify: inter-word;">Business Process Outsourcing (BPO) is a management strategy that helps business to achieve higher operational excellence and gain competitive advantage by outsourcing business processes to an external company that handles, improves, and manages processes based on predefined goals and needs.<br><br><strong>Our Value Added Services</strong> Some of the most commonly outsourced value added services include:</p>
                        <br>
                ...
                <ul>
                    <li class="moto-text_186">Customer Support </li>
                    <li class="moto-text_186">Back Office Services </li>
                    <li class="moto-text_186">Phone Based </li>
                    <li class="moto-text_186">Data Research & Integration  </li>

                </ul>
                    </div>
                    </div>
                    <div class="col-sm-6">
                          <img src="images/vas.png"  ><p class="moto-text_normal"></p>
                    </div>
                </div>
