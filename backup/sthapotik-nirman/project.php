                    ...
                    <div class="container-fluid">
                            ...
                            <div class="" id="portfolio-grid" style="margin-top: 10px;">
                                <div class="container">
                                    <?php
                                        ...
                                        $total_pages_sql = "SELECT COUNT(*) FROM sub_projects WHERE project_id = '$projectId'";
                                        $result2 = mysqli_query($conn,$total_pages_sql);
                                        $total_rows = mysqli_fetch_array($result2)[0];
                                        $total_pages = ceil($total_rows / $no_of_records_per_page);


                                        $sqlSubProject = "SELECT id, sub_name, sub_image, sub_hover_text, sub_description FROM sub_projects WHERE project_id = '$projectId' LIMIT $offset, $no_of_records_per_page";
                                        $resultSubProject = mysqli_query($conn, $sqlSubProject);

                                        if (mysqli_num_rows($resultSubProject) > 0) {
                                            // output data of each row
                                            while($rowSubProject = mysqli_fetch_assoc($resultSubProject)) {
                                    ?>


                                    <div style="height: 280px;" class="item col-sm-3" data-toggle="modal" data-target="#myModal<?php echo $rowSubProject["id"]; ?>">
                                            <figure>
                                                <?php
                                                    if ($rowSubProject["sub_image"] == null) {
                                                ?>
                                                        <img alt="Image" src="assets/images/COVERPAGE.jpg" width="420" height="280">
                                                <?php
                                                    } else {
                                                ?>
                                                        <!-- <img alt="Image" src="assets/uploads/<?php echo $rowSubProject['image']; ?>" width="420" height="280"> -->
                                                        <img alt="Image" class="img-responsive" src="assets/subuploads/<?php echo $rowSubProject['sub_image']; ?>" style="max-height: 100%; width: auto;">
                                                <?php
                                                    }
                                                ?>
                                                <figcaption>
                                                    <h3 style="color: #FFFFFF;"><?php echo $rowSubProject["sub_name"]; ?></h3>
                                                    <p style="font-size: 16px; color: #FFFFFF;"><b><?php echo $rowSubProject["sub_hover_text"]; ?></b></p>
                                                </figcaption>
                                            </figure>   
                                        </div>

                                        <!-- Modal -->
                                        <div class="modal fade" id="myModal<?php echo $rowSubProject["id"]; ?>" role="dialog">
                                            ...
                                            <!-- <div class="modal-dialog modal-lg" style="margin-top: 100px; width: 1300px;"> -->
                                                <div class="modal-content">
                                                    ...
                                                    if ($rowSubProject["sub_image"] == null) {
                                                        ...
                                                        ?>
                                                            <!-- <img alt="Image" src="assets/subuploads/<?php echo $rowSubProject['sub_image']; ?>" height="530"> -->
                                                            <!-- <img alt="Image" src="assets/subuploads/<?php echo $rowSubProject['sub_image']; ?>" style="max-width: 100%; height: auto;"> -->
                                                            <img alt="Image" class="img-responsive" src="assets/subuploads/<?php echo $rowSubProject['sub_image']; ?>">
                                                        <?php
                                                ...
                                                ?>
                                                        ...
                                                        <?php
                                                            if($rowSubProject["sub_description"] != null) {
                                                                //$doc = new DOMDocument();
                                                                //$doc->loadHTML($rowSubProject["description"]);
                                                                //echo $doc->saveHTML();
                                                                echo $rowSubProject["sub_description"];
                                                            }
                                                        ?>
                        ...
                        <div class="col-sm-12" style="    margin-top: -80px; margin-bottom: -40px;">
                            <div class="blog-page-nav text-center">
                                <ul>
                                    <li><a href="?projectId=<?php echo $projectId; ?>&pageno=1"><i class="fa fa-angle-double-left"></i> First</a></li>
                                    <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?>">
                                        <a href="<?php if($pageno <= 1){ echo '#'; } else { echo "?projectId=$projectId&pageno=".($pageno - 1); } ?>"><i class="fa fa-angle-left"></i> Prev</a>
                                    </li>
                                    <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>">
                                        <a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?projectId=$projectId&pageno=".($pageno + 1); } ?>">Next <i class="fa fa-angle-right"></i></a>
                                    </li>
                                    <li><a href="?projectId=<?php echo $projectId; ?>&pageno=<?php echo $total_pages; ?>">Last <i class="fa fa-angle-double-right"></i></a></li>
                                </ul>
                            </div>
                        </div>
