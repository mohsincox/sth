    	...
    	<div class="col-sm-8 col-sm-offset-2">
			<div class="panel panel-danger">
			    ...
			    <div class="panel-body">
					...
					<form class="form-horizontal" action="project-upload-edit.php" method="post" enctype="multipart/form-data">
						<input type="hidden" class="form-control" id="project_id" name="project_id" placeholder="Enter Project Id" autocomplete="off" required="required" value="<?php echo $id; ?>">
					  	<div class="form-group">
					    	<label class="control-label col-sm-3" for="project_name">Project Name: <span class="asteriskField">*</span></label>
					    	<div class="col-sm-9">
					      		<input type="text" class="form-control" id="project_name" name="project_name" placeholder="Enter Project Name" autocomplete="off" required="required" value="<?php echo $name; ?>">
					    	</div>
					  	</div>
					  	<div class="form-group">
					    	...
					    	<div class="col-sm-9">
					      		<select class="form-control" id="category_id" name="category_id" required="required">
        							...
        							?>
        							<option <?php if ($categoryId == $row['id']) echo 'selected' ; ?> value="<?php echo $row['id']; ?>"><?php echo $row["name"]; ?></option>
        							<?php
        								}
        							}
        							?>
					  	...
					  	<div class="col-sm-offset-3">
					  		<?php
					  			if (isset($image) != null) {
					  		?>
					  			<img src="assets/uploads/<?php echo $image; ?>" width="100" height="100" id="image-tag">
					  		<?php
					  			} else {
					  		?> 
					  	...
					  	<div class="form-group">
					    	...
					    	<div class="col-sm-9">
					      		<input type="text" class="form-control" id="hover_text" name="hover_text" placeholder="Enter Text Hover" autocomplete="off" value="<?php echo $hoverText; ?>">
					    	</div>
					  	</div>
