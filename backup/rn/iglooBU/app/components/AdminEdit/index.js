...
export class Test extends Component {
  ...
  async getAlertWeb() {
    ...
    return fetch(`http://192.168.100.83/laravel-test2/ticket/admin-edit/${this.props.navigation.state.params.JSON_ListView_Clicked_Item}`)
  ...
  checkLogin(tt) {
    ...
    fetch('http://192.168.100.83/laravel-test2/admin-remarks', {
      method: 'POST',
      headers: {
