...
export default class AdminTicket extends Component {
  ...
  // }
    ...
    getListViewItem = (item) => {  
      ...
      async getAlertWeb() {
        ...
        return fetch(`http://192.168.100.83/laravel-test2/ticket/admin/date/${this.props.navigation.state.params.requestDate}`)
