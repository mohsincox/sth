...
class UserTicket extends Component {
    ...
    async getAlertWeb() {
        ...
        // return fetch(`http://192.168.100.83/iglooapp/user-date/ticket/${this.props.navigation.state.params.requestDate}`)
        return fetch(`http://202.51.177.67:8034/iglooapp/user-date/ticket/${this.props.navigation.state.params.requestDate}`)
        ...
        return (
            <ScrollView>
                <View style={styles.container}>
                    <Text style={{ fontSize: 25, textAlign: 'center', textDecorationLine: 'underline' }}>UTicket List of { this.props.navigation.state.params.requestDate }</Text>
