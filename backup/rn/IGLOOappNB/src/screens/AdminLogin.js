...
class AdminLogin extends Component {
    ...
    checkLogin() {
        ...
        fetch('http://202.51.177.67:8034/iglooapp/admin-login', { method: 'POST', body: JSON.stringify({username,password})})
        .then(res => {
            return res.text()
        })
        .then(res => {
                ...
                <Content>
                    <Card>
                        ...
                        <Form>
                            ...
                            <Button style={{margin:10}} primary block rounded  onPress={_ => this.checkLogin() }><Text>Admin Login</Text></Button>
                        </Form>
