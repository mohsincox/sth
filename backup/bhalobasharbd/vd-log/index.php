		...
		<div class="col-sm-offset-0 col-sm-12">
		  	<div class="panel panel-primary">
			    <div class="panel-heading text-center">
			    	<b><i style="font-size: 18px;">Date wise Log Report</i></b>
			    </div>
				    	...
				    	<div class="col-sm-12">
							<?php
          						if(isset($_POST["submit"]))
          						{
									...
									$sql = "SELECT uniqueid, length_in_sec, phone_number, call_date  FROM `vicidial_log` WHERE status = 'SVYHU' AND (`call_date` BETWEEN '$startDateTime' AND '$endDateTime')";
					              		...
					              		<?php
       									...
       									?>
       		 							<tr>
				                          	...
				                          	<td><?php echo $row["length_in_sec"]; ?></td>
