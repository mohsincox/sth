...
class ProductBloc {
  ...
  Stream<bool> get productValid =>
      Rx.combineLatest2(productName, productPrice, (a, b) => true);
  ...
  submitProduct() {
    print(
        "Product Submitted with Name: ${_productName.value} and Price: ${_productPrice.value}");
  }
}
