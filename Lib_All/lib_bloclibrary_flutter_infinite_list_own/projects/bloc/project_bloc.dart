...
class ProjectBloc extends Bloc<ProjectEvent, ProjectState> {
  ...
  ProjectBloc({@required this.httpClient}) : super(ProjectInitial());
  ...
  Stream<ProjectState> mapEventToState(
    ...
    if (event is ProjectFetched) {
      yield* _mapProjectFetchedToState();
    }
  }

  Stream<ProjectState> _mapProjectFetchedToState() async* {
    try {
      final List<Project> projects = await _fetchProjects();
      yield ProjectSuccess(projects);
    } catch (_) {
      yield ProjectFailure();
    }
  }
