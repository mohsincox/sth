...
<!-- <link rel="stylesheet" type="text/css" href="v_stylesheet.php"> -->
...
?>
<TABLE WIDTH=<?php echo $page_width ?> BGCOLOR=#ffffff cellpadding=2 cellspacing=0><TR BGCOLOR=#ffffff><TD ALIGN=LEFT><FONT FACE="ARIAL,HELVETICA" SIZE=2><B> &nbsp; <?php echo _QXZ("Audio Store"); ?></TD><TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA" SIZE=2><B> &nbsp; </TD></TR>

<?php 

echo "<TR BGCOLOR=\"#ffffff\"><TD ALIGN=LEFT COLSPAN=2><FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=3><B> &nbsp; \n";
...
<table align=center width="700" border=0 cellpadding=5 cellspacing=0 bgcolor=#e8e8e8>
  <tr>
	<td align=right width="35%"><B><font face="arial, helvetica" size=2><?php echo _QXZ("Audio File to Upload"); ?>:</font></B></td>
	<td align=left width="65%"><input type=file name="audiofile" value=""> </td>
  </tr>
  <tr>
	<td align=center colspan=5><input type=submit name=submit value='<?php echo _QXZ("Submit"); ?>'></td>
  </tr>
